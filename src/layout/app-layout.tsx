...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hr-manager', 'owner', 'job-candidate', 'employee', 'team-lead'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Candidate Shortlistings',
      path: '/candidate-shortlistings',
    ...
    { name: 'Interviews', path: '/interviews', entity: 'interviews', service: AccessServiceEnum.PROJECT, icon: FiMic },
    {
    ...
    {
      name: 'Payroll Informations',
      path: '/payroll-informations',
    ...
    { name: 'Tests', path: '/tests', entity: 'tests', service: AccessServiceEnum.PROJECT, icon: FiCheckSquare },
    {
      name: 'Vacation Managements',
      path: '/vacation-managements',
