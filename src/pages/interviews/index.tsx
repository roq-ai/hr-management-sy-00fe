...
import { getInterviews, deleteInterviewsById } from 'apiSdk/interviews';
...
export function InterviewsListPage(props: InterviewsListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<InterviewsInterface>>(
