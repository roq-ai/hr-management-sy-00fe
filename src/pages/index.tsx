  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Streamline Your Employee Data, Time Tracking, and Payroll in One Central Place. Enhance Performance Evaluations, Simplify Hiring Process with Skill Hire. Manage Vacations and Job Postings Efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Streamline Your Employee Data, Time Tracking, and Payroll in One Central Place. Enhance Performance Evaluations, Simplify Hiring Process with Skill Hire. Manage Vacations and Job Postings Efficiently.`}
            </Text>
            <Box
