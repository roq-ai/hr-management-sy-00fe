-- CreateTable
CREATE TABLE "candidate_shortlistings" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "candidate_shortlistings_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "payroll_information" (
    ...
    CONSTRAINT "payroll_information_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "vacation_management" (
    ...
    CONSTRAINT "vacation_management_pkey" PRIMARY KEY ("id")
);
